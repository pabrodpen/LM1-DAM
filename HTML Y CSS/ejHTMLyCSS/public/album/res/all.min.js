...
;Texts = {and:'y',from:'From {0}',databaseMissingOrBroken:'The current folder´s database file is missing or broken!',checkProcessSubdirectories:'Check if you´ve allowed jAlbum to process the subdirectories and "Make album" again!',uploadAlbumAgain:'If you´re the owner try to "Upload" the album again!',localAccessBlocked:'Local access to the album´s database file is blocked by your browser. This does not affect the uploaded album! Use jAlbum´s Preview (F12) for testing!',cantLoadDataForFolder:'Can´t load data for folder "{0}"!',closeWindow:'Cerrar ventana',okButton:'OK',warning:'Advertencia',error:'Error',restrictedLinkTitle:'Restricted material',restrictedLinkQuestion:'Please verify your age to proceed!',restrictedLinkYes:'I´m over 18',restrictedLinkNo:'I´m below 18',today:'hoy',yesterday:'ayer',daysAgo:'{0} días',monthsAgo:'{0} meses atrás',yearsAgo:'{0} años atrás',addCart:'Añadir la carro',shoppingCart:'Cesta de la compra',edit:'Editar',continueShopping:'Seguir comprando',added:'Añadido ...',buyNow:'Comprar ahora',processedByPaypal:'Pago procesado por PayPal',view:'View',selectItems:'Select items to add!',addSelectedItems:'Add selected items!',emptyCart:'Carrito vacío',removeAllItems:'¿Eliminar todos los elementos?',yes:'Si',no:'No',noMoreItems:'You can´t buy more than 99 items at once at PayPal. Added only the first 99.',item:'artículo',items:'artículos',success:'Éxito',couponCode:'Código de cupón',redeem:'canjear',noSuch:'¡No existe tal cupón!',expired:'¡El código de cupón <b> {0} </ b> ha expirado!',lowerThanCurrent:'Este cupón ofrece un descuento menor que el actual <b> {0} </ b>.',reclaimed:'¡Este cupón ya se ha utilizado!',select:'Seleccionar',all:'Pequeño',none:'Ninguna',selectedItems:'Selected items',shoppingcartInfo:'Este artículo ha sido agregado al "Carro de la compra". Puede comprarlo haciendo clic en el botón "Comprar ahora" después de salir de la caja de luz.',subtotal:'Subtotal',total:'Total',shippingAndHandling:'Envío y manipulación',reduction:'Reducción',discount:'Descuento',tax:'Impuestos',remove:'Eliminar',couponAccepted:'Se aceptó el código de cupón, descontando <b>{0}</b>.',couponRemoved:'Se eliminó el cupón.',amountLowerThan:'El importe es inferior al descuento <b>{0}</b>.',addMoreItems:'Añadir {0} más elementos para usar este cupón!',validAbove:'Válido sólo por encima de {0} valor del carro.',higherThanTotal:'El cupón ofrece un descuento mayor (<b>{0}</b>) que el total del carrito.',minAmountWarning:'Este cupón solo se puede usar si la cantidad total supera <b>{0}</b>.',minQuantityWarning:'Este cupón sólo se puede utilizar si el número de elementos supera <b>{0}</b>.',maxNItems:'Máximo <b>{0}</b> elementos permitidos!',continueBrowsing:'Continue browsing',feedback:'Feedback',sendFeedback:'Send feedback',addComment:'Add comment',writeFeedback:'Write feedback',addFeedback:'Add feedback',addFeedbackCart:'Feedback on images',view:'View',feedbackOnAlbum:'Feedback on album "{0}"',removeAll:'Remove all',removeAllItems:'¿Eliminar todos los elementos?',to:'To',subject:'Subject',warning:'Advertencia',copiedToClipboard:'Copied to clipboard!',errorSending:'Error sending',emailMissing:'Email missing',tooLong:'This is too long to pass to the email application directly.',copyInstructions:'The text has been copied to your clipboard. Now switch to the email application (or webmail) and paste it. Move "To" and "Subject" into the appropriate boxes!',feedbackButtonExplanation:'Try "Send" if you have an email application installed, use "Copy" for webmail!',message:'Message',share:'Compartir',shareOn:'Compartir en',checkThisOut:'A comprobar',email:'Email',copy:'Copy',copied:'Copied',slideshow:'Presentación',localWarning:'No se pueden compartir los álbumes locales. ¡Cargue su álbum primero!',foundNTimes:'{0} imagen (s)',notFound:'No encontrado',search:'Buscar',searchPlaceholder:'Search...',newImages:'Nuevas imágenes',results:'Results',reset:'Reset',label:'Etiqueta',return:'return',select:'Seleccionar',sortBy:'Sort by',sortedBy:'Sorted by',ascending:'ascending',descending:'descending',multipleSelectHint:'Use SHIFT to select range, CTRL for multiple entries',noRating:'No rating',newItem:'NUEVO',today:'hoy',inThePast24Hours:'in the past 24 hours',inThePast48Hours:'in the past 48 hours',inTheLastDay:'en el último día',inThePastNDays:'en el pasado {0} días',inThePastNMonths:'en el pasado {0} meses',inThePastNYears:'en el pasado {0} años',sinceMyLastVisit:'desde mi última visita',betweenDays:'between {0} and {1}',onDay:'on {0}',beforeDay:'before {0}',afterDay:'after {0}',imagesAdded:'Imágenes añadidas',imagesModified:'Imágenes modificadas',imagesTaken:'Imágenes tomadas',startSlideshow:'Iniciar presentación de diapositivas',startSlideshowShort:'Play',atFirstPage:'En la primera página',atLastPage:'En la última página',atLastPageQuestion:'¿A dónde ir después?',startOver:'Empezar de nuevo',backToHome:'Volver al inicio',nextIndex:'Next index page',stop:'Parar',pause:'Pausa',pauseShort:'Pause',upOneLevel:'Arriba un nivel',upOneLevelShort:'Exit',backToIndex:'Volver a la página de índice',previousPicture:'Imagen anterior',previousPictureShort:'Prev',nextPicture:'Imagen siguiente',nextPictureShort:'Next',previousFolder:'carpeta anterior',nextFolder:'carpeta siguiente',zoom:'Zoom',oneToOneSize:'Tamaño 1:1',oneToOneSizeShort:'1:1',fullscreen:'Fullscreen',exitFullscreen:'Exit fullscreen',fullscreenShort:'Fullscr',exitFullscreenShort:'Normal',fitToScreen:'Ajustar a la pantalla',fitToScreenShort:'Fit',showInfo:'Mostrar titulo / información',showInfoShort:'Info',hideInfo:'Ocultar titulo / información',hideInfoShort:'Hide info',showThumbs:'Mostrar miniaturas',showThumbsShort:'Thumbnails',hideThumbs:'Ocultar miniaturas',hideThumbsShort:'Hide thumbs',clickToOpen:'Hacer clic para abrir este documento con el programa asociado',play:'Play',audioClipLabel:'Play / pause the attached audio clip',rating:'Rating',metaBtn:'Datos fotográficos',metaLabel:'Mostrar los datos fotográficos (Exif/Iptc)',mapBtn:'Mapa',mapLabel:'Mostrar la ubicación de la foto en el mapa',shopBtn:'Comprar',shopLabel:'Mostrar las opciones para la compra de este artículo',viewCart:'View cart',viewCartLabel:'View shopping cart',feedbackLabel:'View feedback window',shareBtn:'Compartir',shareLabel:'Compartir esta foto en sitios sociales',download:'Descargar',print:'Imprimir',printLabel:'Print out this photo on your printer',fotomotoBtn:'Comprar / Compartir',fotomotoTooltip:'Comprar impresiones o archivos digitales, compartir, enviar eCards gratis',mostphotosBtn:'Compra',mostphotosLabel:'Descargue esta imagen de <b>mostphotos.com</b>!',regionsBtn:'People',regionsLabel:'Show tagged people',scrollTopTooltip:'Top',new:'New',more:'más',less:'menos',locationWarning:'Sólo funciona cuando se carga',cookiePolicyText:'Este álbum utiliza cookies para recordar las preferencias del usuario. Al usarlo, usted acepta nuestro uso de cookies.',cookiePolicyAgree:'Lo tengo',cookiePolicyLearnMore:'Más información',gdprComplianceText:'This site is using the following external services that might track your visits anonymously. Disabling tracking will stop their functionality.',allowAll:'Allow all',denyAll:'Deny all',allowSelected:'Allow selected',image:'imagen',images:'imágenes',audio:'audio',audios:'audios',video:'video',videos:'videos',other:'other',others:'others'};
