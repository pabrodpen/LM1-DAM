...
let pintarNombre=()=>{
    document.getElementById("nombre").style.backgroundColor='blue';
}

let pintarClave=()=>{
    document.getElementById("clave").style.backgroundColor='red';
}

let resetearColor=(dato)=>{
    dato.style.backgroundColor='';
}

let enlaces=(url)=>{//IMP-->PONER DE PARAMETRO EL ENLACE E IR CAMBIANDO
    window.location=url;
}